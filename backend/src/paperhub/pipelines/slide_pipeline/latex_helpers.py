# Adapted from reference/paper2slides-plus/src/latex_utils.py @ 88515c4
...
def add_additional_tex(content: str) -> str:
    ...
    def _inserter(m: re.Match[str]) -> str:
...
def sanitize_frametitles(beamer_code: str) -> str:
    ...
    if re.search(r"\\(toprule|midrule|bottomrule|cmidrule)", beamer_code) and (
    ...
    if "\\multirow" in beamer_code and "\\usepackage{multirow}" not in beamer_code:
    ...
    def repl_frame(match: re.Match[str]) -> str:
