...
SETTINGS_REGISTRY: list[SettingField] = [
    ...
    SettingField("PAPERHUB_SQL_AGENT_MODEL", "models_providers", "SQL agent", "string",
                 advanced=True,
                 help="library_stats ReAct agent (reason → query → curate → answer). Defaults to the small tier."),
